...
const AboutMe = () => {
    return (
        <>
            ...
            <p>
                Prima di scrivere la prima riga, immagino il percorso completo dell'applicazione — flussi, interazioni, possibili errori. Poi, durante lo sviluppo, esploro attivamente i vari casi d'uso per verificare che tutto regga nella pratica.
            </p>
            <p>
